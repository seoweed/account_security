...
class AccountSecurityApplicationTests {
	...
	@Test
	void AccountSave() {
//		UserEntity joohopUserEntity = new UserEntity("joohop", "1234", "USER");
//		AccountInfoEntity entity = new AccountInfoEntity(1L, "weed", "qe12", "123", LocalDateTime.now(), joohopUserEntity);
